...
@section('content')
<form action="/consoles/edit/submit/{{ $console->id }}" method="post" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col">
          ...
          <div class="form-group">
            ...
            value="{{ old('name') ? old('name') : $console->name  }}">
          ...
          <div class="form-group">
            ...
            <div class="form-check">
              ...
              @if (!old('type') && $console->type === "nintendo") 
                  checked
              @endif>
            ...
            <div class="form-check">
              ...
              @if (!old('type') && $console->type === "playstation") 
                  checked
              @endif>
          ...
          <div class="form-group">
            ...
            value="{{ old('price_per_day') ? old('price_per_day') : $console->price_per_day  }}">
            <div class="invalid-feedback">
          ...
          <div class="form-group">
            ...
            value="{{ old('qty') ? old('qty') : $console->qty  }}">
            <div class="invalid-feedback">
          ...
          <div class="form-group">
            ...
            rows="4" cols="50"
            maxlength="240">{{ old('description') ? old('description') : $console->description }}</textarea>
            <div class="invalid-feedback">
          ...
          <div class="form-group">
            <label for="picture">Change Console Picture: </label>
            
            <div class="row mb-2">
                <img src="{{ asset('console_images/' . $console->picture) }}" width="150px">
            </div>
            <div class="row">
